<div
	class="overflow-y-auto max-w-48 md:max-w-64 flex grow flex-col gap-y-5 border-r border-gray-200 bg-white px-6"
>
					...
					<li>
						<div>
							...
							>
								...
								<svg
									class="ml-auto size-5 shrink-0 text-gray-400"
									viewBox="0 0 20 20"
									fill="currentColor"
									aria-hidden="true"
									data-slot="icon"
